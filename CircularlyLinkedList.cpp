...
public:
    ...
    void insertInList(int position, int value){
        ...
        if (position == 1){
            ...
            if(position == size + 1){newNode->next = head;}
    ...
    void deleteInList(int position){
        ...
        if (position == 1){
            ...
            if(position == size+1){temp->next = head;}
            else{temp->next = deleteNode->next;}
            delete deleteNode;
        }
        --size;
